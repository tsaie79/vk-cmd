...
ref[1] This package is based on Virtual Kubelete - https://github.com/virtual-kubelet/virtual-kubelet.
ref[2] Vk-cmd is based on vk-mock in the above repo and stored in: https://github.com/tsaie79/virtual-kubelet-cmd.
